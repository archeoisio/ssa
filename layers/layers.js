...
lyr_affore12_6.set('fieldLabels', {'id': 'no label', 'SEZIONE': 'no label', '% ore 12': 'inline label - visible with data', '% ore 19': 'inline label - visible with data', '% ore 23': 'inline label - visible with data', });
lyr_affore19_7.set('fieldLabels', {'id': 'no label', 'SEZIONE': 'no label', '% ore 12': 'no label', '% ore 19': 'no label', '% ore 23': 'no label', });
lyr_affore23_8.set('fieldLabels', {'id': 'no label', 'SEZIONE': 'no label', '% ore 12': 'no label', '% ore 19': 'no label', '% ore 23': 'no label', });
