...
var style_affore19_7 = function(feature, resolution){
    ...
    if (size == 1) { // If cluster has one feature
        ...
        value = clusteredFeatures[0].get("% ore 19");
        if ("" !== null) {
            labelText = String("");
        }
    ...
    if (value >= 0.000000 && value <= 31.340000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 31.340000 && value <= 33.270000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 33.270000 && value <= 34.700000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 34.700000 && value <= 36.720000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 36.720000 && value <= 41.610000) {
            style = [ new ol.style.Style({
